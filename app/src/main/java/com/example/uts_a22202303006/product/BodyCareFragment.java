...
public class BodyCareFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        homeViewModel.getBodyCareProducts().observe(getViewLifecycleOwner(), products -> {
        ...
        homeViewModel.fetchBodyCareProducts(""); // Fetch all products initially
        // Observe search query changes
        homeViewModel.getSearchQuery().observe(getViewLifecycleOwner(), query -> {
            if (query != null) {
                homeViewModel.fetchBodyCareProducts(query); // Fetch products based on query
            }
        });
...
//        homeViewModel.getSearchQuery().observe(getViewLifecycleOwner(), query -> {
//            if (query != null) {
//                homeViewModel.fetchBodyCareProducts(query);
//            }
//        });
